...
- [x] [P36.9] 手动测试与交付记录。
  - 按 `docs/development/ManualTestProtocol.md` 执行本轮手动测试。
  ...
  - 新增或更新的手动测试用例必须记录到 `docs/development/manual-tests/`。
  - 手动测试报告写入：`docs/development/manual-tests/runs/YYYY-MM-DD_P36_LiveSidecar.md`。
...
手动测试报告：`docs/development/manual-tests/runs/2026-05-06_P36_LiveSidecar.md`
