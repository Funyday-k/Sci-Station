...
- [ ] [P38.9] 手动测试与交付记录。
  ...
  - 手动测试报告写入：`docs/development/manual-tests/runs/YYYY-MM-DD_P38_ArtifactLifecycle.md`。
...
Git commit：
自动化测试结果：
手动测试报告：docs/development/manual-tests/runs/YYYY-MM-DD_P38_ArtifactLifecycle.md
已知问题：
