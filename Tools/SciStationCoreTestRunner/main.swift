...
private struct CoreVerificationSuite {
    func runAll() async throws {
        ...
        try await recommendationScorerRanksByLibraryInterest()
        try await recommendationPipelineWritesSnapshot()
    ...
    private func recommendationScorerRanksByLibraryInterest() async throws {
