...
- 生成标准化文件：paper.pdf、meta.yaml、annotations.md
...
1. 先补上 Markdown 知识库和 wiki/papers 页面，形成论文到知识页的落地链路。
2. 再接入 LLM Provider，把“导入 PDF -> 生成总结 -> 写入 wiki”做成闭环。
3. 最后补搜索、外部 PDF 阅读器联动和 VSCode 集成，提升实际使用效率。
