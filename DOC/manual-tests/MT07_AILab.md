...
P39.12 手动报告路径：`DOC/manual-tests/runs/2026-05-07_P39.12_AILabReleaseGate.md`。
...
P39.13 手动报告路径：`DOC/manual-tests/runs/2026-05-07_P39.13_DebugArchivePaperRouting.md`。
...
P39.15 手动报告路径：`DOC/manual-tests/runs/2026-05-07_P39.15_AILabMarkdownWritebackBudget.md`。
