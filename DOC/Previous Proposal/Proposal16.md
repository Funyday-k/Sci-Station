...
下一阶段不继续扩大 Agent 能力，而是按 `DOC/Comment.md` 的设计审阅意见进入 Mac 基础体验补齐。目标是先处理低风险、高体感、可验证的系统行为：菜单命令、快捷键、搜索入口、Reader/Wiki 保存体验、删除文案、关键图标按钮可访问性和空状态下一步操作。
...
下一轮任务书见 [DOC/Proposal17.md](Proposal17.md)。
