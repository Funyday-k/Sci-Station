...
public nonisolated enum L10n {
    ...
    private static let english: [L10nKey: String] = [
        ...
        .homeWidgetReadingPlan: "Reading Todo",
        ...
        .homeReadingPlanEmpty: "No papers are in Reading Todo yet.",
    ...
    private static let simplifiedChinese: [L10nKey: String] = [
        ...
        .homeReadingPlanEmpty: "还没有论文进入阅读 Todo。",
