...
public nonisolated struct CreateTodoAgentTool: AgentTool {
    ...
    public nonisolated var definition: AgentToolDefinition {
        AgentToolDefinition(
            ...
            inputSchema: "{\"title\":\"string\",\"due_date\":\"yyyy-MM-dd optional\",\"priority\":\"low|medium|high|urgent optional\",\"notes\":\"string optional\",\"tags\":[\"string\"],\"related_paper_ids\":[\"paper id\"]}",
...
public nonisolated struct UpdatePaperClassificationAgentTool: AgentTool {
    ...
    public nonisolated var definition: AgentToolDefinition {
        AgentToolDefinition(
            ...
            summary: "Update a paper's tags, categories, reading status, or priority.",
            inputSchema: "{\"paper_id\":\"paper id optional when a paper is selected\",\"tags\":[\"string\"],\"categories\":[\"string\"],\"priority\":\"low|medium|high|urgent optional\",\"status\":\"unread|skimmed|deepRead|summarized|used|rejected optional\"}",
            risk: .writesWorkspace,
            requiresConfirmation: true,
