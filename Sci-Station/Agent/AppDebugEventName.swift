...
///
/// See DOC/comment.md §8.1 and DOC/Proposal-AT.md §P-AT.1.
public enum AppDebugEventName: String, Codable, CaseIterable, Sendable {
    ...
    // MARK: - Research Queue (P48)
    case queueLoad = "queue.load"
    case queueLoadError = "queue.load.error"
    case queueAppend = "queue.append"
    case queueReorder = "queue.reorder"
    case queueRemove = "queue.remove"
    case queueStatusChange = "queue.status_change"
    case queueSaveError = "queue.save_error"
